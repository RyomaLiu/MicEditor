let MicEditor = function (editorID) {

    mic_editor = document.getElementById(editorID);
    mic_editor.classList.add('mic_editor');
    ...
    createMenu = function () {
        mic_menu = document.createElement('div');
        mic_menu.setAttribute('id', 'mic_menu');
        mic_menu.classList.add('mic_menu');
        mic_editor.appendChild(mic_menu);

        mic_menu_items = document.createElement('ul');
        mic_menu_items.setAttribute('id', 'mic_menu_items');
        mic_menu_items.classList.add('mic_menu_items');
        mic_menu.appendChild(mic_menu_items);
    ...
    createContentContainer = () => {
        mic_content = document.createElement('div');
        mic_content.setAttribute('id', 'mic_content');
        mic_content.classList.add('mic_content');
        mic_editor.appendChild(mic_content);
    ...
    setEditable = (editable = true) => {
        mic_content.setAttribute('contentEditable', editable);
    }
    ...
    //        }.bind(this));
    //
    //        mic_menu_items.appendChild(item_h1);
    //    }
    //
    //    createH2() {
    ...
    //        });
    //
    //        mic_menu_items.appendChild(item_h2);
    //    }
    //
    //    createH3() {
    ...
    //        });
    //
    //        mic_menu_items.appendChild(item_h3);
    //    }
    //
    //    createBold() {
    ...
    //
    //        mic_menu_items.appendChild(item_bold);
    //    }
    //
    //
    //    createPickColor() {
    ...
    //        });
    //
    //        mic_menu_items.appendChild(item_color);
    //    }
    //
    //    createFont() {
    ...
    //        </svg>`;
    //
    //        mic_menu_items.appendChild(item_font);
    //    }
    //
    //    createQuote() {
    ...
    //        </svg>`;
    //
    //        mic_menu_items.appendChild(item_quote);
    //    }
    //
    //
    //    createLink() {
    ...
    //        </svg>`;
    //
    //        mic_menu_items.appendChild(item_link);
    //    }
    //
    //    createCode() {
    ...
    //        </svg>`;
    //
    //        mic_menu_items.appendChild(item_code);
    //    }
    //
    //    createImage() {
    ...
    //        </svg>`;
    //
    //        mic_menu_items.appendChild(item_image);
    //    }
    //
    //    createTable() {
    ...
    //        </svg>`;
    //
    //        mic_menu_items.appendChild(item_table);
    //    }
    //
    //    createEmoji() {
    ...
    //        </svg>`;
    //
    //        mic_menu_items.appendChild(item_emoji);
    //    }
    //
    //    createToc() {
    ...
    //        </svg>`;
    //
    //        mic_menu_items.appendChild(item_toc);
    //    }
    //
    //    createItalic() {
    ...
    //        </svg>`;
    //
    //        mic_menu_items.appendChild(item_italic);
    //    }
    //
    //    createUnderline() {
    ...
    //        </svg>`;
    //
    //        mic_menu_items.appendChild(item_underline);
    //    }
    //
    //    createStrike() {
    ...
    //        </svg>`;
    //
    //        mic_menu_items.appendChild(item_strike);
    //    }
